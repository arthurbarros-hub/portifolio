  ...
  return (
    <footer className="relative border-t border-white/10 bg-surface/50 backdrop-blur-xl">
      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-[1180px] px-5 py-12 sm:px-6 sm:py-14 lg:px-8 lg:py-16">
          <motion.div
          ...
          >
            ...
            <motion.div variants={revealVariants} className="lg:col-span-1">
              <div className="flex flex-col gap-3">
                <h3 className="text-lg font-bold text-white sm:text-xl">Arthur Mansur</h3>
                ...
                <nav className="flex flex-col gap-2">
                  {quickLinks.map((link) => (
                    <button
                      ...
                      className="text-sm text-left text-muted transition-colors duration-200 hover:translate-x-1 hover:text-white transform"
                    >
                      {link.label}
                    </button>
                  ))}
                ...
                <div className="flex flex-col gap-2.5">
                  {socialLinks.map((link) => (
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-muted transition-colors duration-200 group hover:text-accent"
                    >
                      {link.icon}
          ...
          <motion.div
            ...
            whileInView="show"
            viewport={{ once: true }}
            className="flex flex-col items-center justify-between gap-3 sm:flex-row sm:gap-5"
          >
