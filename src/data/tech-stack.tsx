...
export const NextIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    ...
    <path fillRule="evenodd" d="M17.089 5.5H5v13h12.089V5.5zm-6.5 0.5h4v10h-4v-10z" fill="currentColor" />
  </svg>
);
...
export const JavaIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <path d="M8 9c1.7 0 3-1.3 3-3S9.7 3 8 3 5 4.3 5 6s1.3 3 3 3zm0 2C5.8 11 3 12.8 3 15v3h10v-3c0-2.2-2.8-4-5-4zm8-2c1.7 0 3-1.3 3-3s-1.3-3-3-3-3 1.3-3 3 1.3 3 3 3zm0 2c-2.2 0-5 1.8-5 4v3h10v-3c0-2.2-2.8-4-5-4z" fill="#0093B0" />
  </svg>
);

export const NodeIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3-8c0 1.66-1.34 3-3 3s-3-1.34-3-3 1.34-3 3-3 3 1.34 3 3z" fill="#7FD07A" />
  </svg>
);
...
export const MySQLIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
    <path d="M3 3h18v4H3V3zm0 6h18v4H3V9zm0 6h18v4H3v-4zm0 6h18v2H3v-2z" fill="#00AFC7" />
  </svg>
);
